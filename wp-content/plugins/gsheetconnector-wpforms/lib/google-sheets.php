...
class wpfgsc_googlesheet {
   ...
   public static function updateToken($tokenData) {
      $tokenData['expire'] = time() + intval(isset($tokenData['expires_in']) ? $tokenData['expires_in'] : 0);
      try {
         ...
         if(isset($tokenData['scope'])){
            ...
            if((in_array("https://www.googleapis.com/auth/drive.metadata.readonly",$permission)) && (in_array("https://www.googleapis.com/auth/spreadsheets",$permission))) {
               ...
               update_option('wpform_gs_verify', 'Something wrong ! Please Deactivate and Do Re-Auth Code : Please Checked below option when getting authentication code : (1)See information about your Google Drive files. (2) 
